...
func _process(_delta: float):
	...
	N3DS.update_button(N3DS.Button.A, Input.is_action_pressed("n3ds_a"))
	N3DS.update_button(N3DS.Button.B, Input.is_action_pressed("n3ds_b"))
	N3DS.update_button(N3DS.Button.X, Input.is_action_pressed("n3ds_x"))
	N3DS.update_button(N3DS.Button.Y, Input.is_action_pressed("n3ds_y"))
...
#	N3DS.update_button(N3DS.Button.RIGHT, Input.is_action_pressed("n3ds_right"))
	N3DS.update_button(N3DS.Button.START, Input.is_action_pressed("n3ds_start"))
	N3DS.update_button(N3DS.Button.SELECT, Input.is_action_pressed("n3ds_select"))
	N3DS.update_button(N3DS.Button.L, Input.is_action_pressed("n3ds_l"))
	N3DS.update_button(N3DS.Button.ZL, Input.is_action_pressed("n3ds_zl"))
	N3DS.update_button(N3DS.Button.R, Input.is_action_pressed("n3ds_r"))
	N3DS.update_button(N3DS.Button.ZR, Input.is_action_pressed("n3ds_zr"))
	if Input.is_action_pressed("n3ds_reset"):
		N3DS.press(N3DS.Button.L)
		N3DS.press(N3DS.Button.R)
		N3DS.press(N3DS.Button.START)
